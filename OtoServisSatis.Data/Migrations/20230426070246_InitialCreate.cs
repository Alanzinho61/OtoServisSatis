        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiseGelisTarii = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AracSurumu = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ServisUcreti = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ServistenCikisTarii = table.Column<DateTime>(type: "datetime2", nullable: false),
                    YapilanIslemler = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GarantiKapasamaindaMi = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    SaseTipi = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Renk = table.Column<int>(type: "int", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", true, new DateTime(2023, 4, 26, 10, 2, 46, 278, DateTimeKind.Local).AddTicks(8978), "admin@otoservissatis.com", "admin", 1, "1234", "admin", "0537" });
